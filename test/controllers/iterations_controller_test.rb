...
class IterationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create iteration" do
    assert_difference('Iteration.count') do
      post iterations_url, params: { iteration: { end_date: @iteration.end_date, start_date: @iteration.start_date } }
    end
  ...
  test "should update iteration" do
    patch iteration_url(@iteration), params: { iteration: { end_date: @iteration.end_date, start_date: @iteration.start_date } }
